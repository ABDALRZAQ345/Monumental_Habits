...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\habittraker\public\storage' => 'string',
            'jwt.secret' => 'string',
            ...
            'logging.channels.emergency.level' => 'string',
            'logging.channels.verification_code.driver' => 'string',
            'logging.channels.verification_code.path' => 'string',
            'logging.channels.verification_code.level' => 'string',
            'mail.default' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\habittraker\\public\\storage','jwt.secret','jwt.keys.public','jwt.keys.private',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.emergency.level','logging.channels.verification_code.driver',
'logging.channels.verification_code.path','logging.channels.verification_code.level','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'signed','throttle','verified','locale','xss',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','telescope',
'forget_password','verificationCode.check','verificationCode.check','register','login',
'password.reset','profile','logout','fcm.send','auth.google','auth.google',
'storage.local',);
        registerArgumentsSet('views', 
'Verification_code','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_CLIENT_ID_MOBILE','GOOGLE_REDIRECT_URI',);
